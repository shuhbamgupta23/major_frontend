...
export const getProduct =
  ...
  async (dispatch) => {
    try {
      ...
      let link = `https://majorbackend-production-0037.up.railway.app/products?keyword=${keyword}&page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&ratings[gte]=${ratings}`;
...
export const createProduct = (productData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `https://majorbackend-production-0037.up.railway.app/admin/product/new`,
      productData,
      config
    );
